...
export const TopRated = () => {
    ...
    return (
        <section id="top-rated" aria-labelledby="top-rated-heading">
        <div className="relative w-full h-auto bg-background flex flex-col items-center justify-center" id="top-rated">
